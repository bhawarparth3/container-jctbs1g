...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jctbs1g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jctbs1g.containers.anotherwebservice.com/
...
```
git clone git@github.com:bhawarparth3/container-jctbs1g.git
cd container-jctbs1g
```
...
```
docker attach container-jctbs1g
```
